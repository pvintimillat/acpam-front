...
class PersonalMedicinaPage extends StatefulWidget {
  @override
  _PersonalMedicinaPageState createState() => _PersonalMedicinaPageState();
}

class _PersonalMedicinaPageState extends State<PersonalMedicinaPage> {
