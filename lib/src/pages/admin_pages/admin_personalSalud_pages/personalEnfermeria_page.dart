...
class PersonalEnfermeriaPage extends StatefulWidget {
  @override
  _PersonalEnfermeriaPageState createState() => _PersonalEnfermeriaPageState();
}

class _PersonalEnfermeriaPageState extends State<PersonalEnfermeriaPage> {
  ...
  Future<Null> _refrescar() async {
    ...
    _especialistas = await personalSaludProvider.cargarPersonalSalud('Enfermería', _desde, _limite);
  }
  ...
  Future fetchData() async {
    ...
    _agregar10();
    final List<PersonalSaludModel> especialistas = await personalSaludProvider.cargarPersonalSalud('Enfermería', _desde, _limite);
