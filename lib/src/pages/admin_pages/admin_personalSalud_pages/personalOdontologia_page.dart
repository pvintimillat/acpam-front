...
class PersonalOdontologiaPage extends StatefulWidget {
  @override
  _PersonalOdontologiaPageState createState() => _PersonalOdontologiaPageState();
}

class _PersonalOdontologiaPageState extends State<PersonalOdontologiaPage> {
  ...
  void initState() { 
    ...
    personalSaludProvider.cargarPersonalSalud('Odontología', _desde, _limite).then((result) {
      setState(() {
        print(result);
  ...
  Future<Null> _refrescar() async {
    ...
    _especialistas = await personalSaludProvider.cargarPersonalSalud('Odontología', _desde, _limite);
  }
  ...
  Future fetchData() async {
    ...
    _agregar10();
    final List<PersonalSaludModel> especialistas = await personalSaludProvider.cargarPersonalSalud('Odontología', _desde, _limite);
